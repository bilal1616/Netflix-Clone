...
email.addEventListener('blur', () => {
    ...
    if (regex.test(str)) {
        ...
        document.getElementsByClassName("form-control")[0].style.border = "1px solid #fff";
        document.getElementsByClassName("form-control")[0].style.boxShadow = "none";
...
password.addEventListener('blur', () => {
    ...
    if (regex.test(str)) {
        ...
        document.getElementsByClassName("form-control")[1].style.border = "1px solid #fff";
        document.getElementsByClassName("form-control")[1].style.backgroundColor = "#fff";
